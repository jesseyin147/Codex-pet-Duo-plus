Create one horizontal animation strip for Codex pet `duo-plus`, state `running-right`.
...
Vividness direction: use an energetic owl scuttle with clearly alternating orange foot strides, rhythmic body squash-and-rise, a forward head lead, and wings counter-swinging close to the body. Keep the cadence cyclic and unmistakably screen-right.
