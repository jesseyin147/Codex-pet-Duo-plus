Create one horizontal animation strip for Codex pet `duo-plus`, state `jumping`.
...
Vividness direction: show a readable five-beat arc—deep anticipation squash, forceful lift, joyful airborne stretch with wings raised, controlled descent, and soft landing squash—using body height and pose only.
